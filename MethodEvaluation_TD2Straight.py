...
def main():
    gtPath = '/data/wd_DBnet_data/PSEnet/PSENet-master/outputs/DB_TestData2_Straight/submit_diy/'
    modelUsed = "XH_Straight"

    if modelUsed == "XH_Straight":
        # Use xh.com online OCR
        predPath = "/data/wd_DBnet_data/onlineDetect/results/"
    elif modelUsed == "myMV3_mixup_99000_withoutOC_Straight":
        # myMV3-mixup-withoutOCoperatio using Straight Input
        predPath = "/data/wd_DBnet_data/Results/TestData2/diy_myMV3_99000_withoutOC_largerInput_Straight/labels/"
    elif modelUsed == "ppOCR_Straight":
        # ppOCR using Straight Input
        predPath = "/data/wd_DBnet_data/ppOCR/DIY_results_TD2_Straight/prediction/"
